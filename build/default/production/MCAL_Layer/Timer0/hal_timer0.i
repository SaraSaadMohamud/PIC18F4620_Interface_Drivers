...
# 34 "MCAL_Layer/Timer0/../Gpio/../mcal_std_types.h"
...
# 1 "MCAL_Layer/Timer0/../../MCAL_Layer/interrupt/mcal_interrupt_cnf.h" 1
# 15 "MCAL_Layer/Timer0/../../MCAL_Layer/interrupt/mcal_interrupt_cnf.h"
# 1 "MCAL_Layer/Timer0/../../MCAL_Layer/interrupt/mcal_interrupt_gen_cfg.h" 1
# 15 "MCAL_Layer/Timer0/../../MCAL_Layer/interrupt/mcal_interrupt_cnf.h" 2
# 67 "MCAL_Layer/Timer0/../../MCAL_Layer/interrupt/mcal_interrupt_cnf.h"
typedef enum{
...
void (*TIMER0_INTERRUPT_SET_HANDELER)(void) = ((void*)0);


static uint16 timer0_preload_value=0;

static __attribute__((inline)) void Timer0_Register_Size(const timer0_config_t * timer);
static __attribute__((inline)) void Timer0_Mode(const timer0_config_t * timer);
static __attribute__((inline)) void Timer0_Edge_Mode(const timer0_config_t * timer);
static __attribute__((inline)) void Timer0_Prescaler_State(const timer0_config_t * timer);
