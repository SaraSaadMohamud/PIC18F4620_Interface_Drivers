...
# 13 "MCAL_Layer/USART/../../MCAL_Layer/mcal_std_types.h"
# 1 "MCAL_Layer/USART/../../MCAL_Layer/std_libraries.h" 1
# 13 "MCAL_Layer/USART/../../MCAL_Layer/std_libraries.h"
...
# 14 "MCAL_Layer/USART/../../MCAL_Layer/std_libraries.h" 2
...
# 15 "MCAL_Layer/USART/../../MCAL_Layer/std_libraries.h" 2
# 13 "MCAL_Layer/USART/../../MCAL_Layer/mcal_std_types.h" 2

# 1 "MCAL_Layer/USART/../../MCAL_Layer/compiler.h" 1
# 11 "MCAL_Layer/USART/../../MCAL_Layer/compiler.h"
...
# 11 "MCAL_Layer/USART/../../MCAL_Layer/compiler.h" 2
# 14 "MCAL_Layer/USART/../../MCAL_Layer/mcal_std_types.h" 2
# 34 "MCAL_Layer/USART/../../MCAL_Layer/mcal_std_types.h"
...
# 1 "MCAL_Layer/USART/../../MCAL_Layer/interrupt/mcal_interrupt_cnf.h" 1
# 15 "MCAL_Layer/USART/../../MCAL_Layer/interrupt/mcal_interrupt_cnf.h"
# 1 "MCAL_Layer/USART/../../MCAL_Layer/interrupt/mcal_interrupt_gen_cfg.h" 1
# 15 "MCAL_Layer/USART/../../MCAL_Layer/interrupt/mcal_interrupt_cnf.h" 2
# 67 "MCAL_Layer/USART/../../MCAL_Layer/interrupt/mcal_interrupt_cnf.h"
typedef enum{
...
# 7 "MCAL_Layer/USART/hal_usart.c" 2
    ...
    static void (*EUSART_TX_INTERRUPT_HANDELER)(void) =((void*)0);



    static void (*EUSART_RX_INTERRUPT_HANDELER)(void) =((void*)0);
    static void (*EUSART_FRAMING_ERROR_INTERRUPT_HANDELER)(void) =((void*)0);
    static void (*EUSART_OVERRUN_ERROR_INTERRUPT_HANDELER)(void) =((void*)0);
...
# 60 "MCAL_Layer/USART/hal_usart.c"
STD_ReturnType EUSART_ASYN_DE_INIT(const usart_config_t * usart_obj)
{
   STD_ReturnType Ret = (STD_ReturnType)0X01;;
   if(((void*)0) == usart_obj)
...
# 83 "MCAL_Layer/USART/hal_usart.c"
STD_ReturnType EUSART_ASYN_WRITE_BYTE_BLOCKING(const usart_config_t * usart_obj,uint8 value)
{
   STD_ReturnType Ret = (STD_ReturnType)0X01;;
   if(((void*)0) == usart_obj)
...
# 111 "MCAL_Layer/USART/hal_usart.c"
STD_ReturnType EUSART_ASYN_WRITE_STRING_BLOCKING(const usart_config_t * usart_obj,uint8 *str,uint16 str_lenght)
{
    STD_ReturnType Ret = (STD_ReturnType)0X01;;
    uint16 str_count=0;

   if((((void*)0) == usart_obj) || (((void*)0) == str))
   {
       Ret = (STD_ReturnType)0X00;;
   }
   else
...
# 139 "MCAL_Layer/USART/hal_usart.c"
STD_ReturnType EUSART_ASYN_READ_BYTE_BLOCKING(const usart_config_t * usart_obj,uint8 * value)
{
   STD_ReturnType Ret = (STD_ReturnType)0X01;;
   if((((void*)0) == usart_obj) || (((void*)0) == value))
   {
       Ret = (STD_ReturnType)0X00;;
   }
   else
       ...
       switch( usart_obj->baudrate_gen_cfg)
        {
            case USART_ASYN_8BIT_LOW_SPEED :
                ...
                TXSTAbits.BRGH = 0;
                BAUDCONbits.BRG16 = 0;
                BaudRate_Temp = ((8000000UL/(float)(usart_obj->baudrate))/64)-1;
                break;
            case USART_ASYN_8BIT_HIGH_SPEED :
                TXSTAbits.SYNC = 0 ;
                TXSTAbits.BRGH = 1;
                BAUDCONbits.BRG16 = 0;
                BaudRate_Temp = ((8000000UL/(float)(usart_obj->baudrate))/16)-1;
                break;
            ...
            case USART_ASYN_16BIT_HIGH_SPEED :
                ...
                TXSTAbits.BRGH = 1;
                BAUDCONbits.BRG16 = 1;
                BaudRate_Temp = ((8000000UL/(float)(usart_obj->baudrate))/4)-1;
                break;
            case USART_SYN_8BIT :
                TXSTAbits.SYNC = 1 ;
                BAUDCONbits.BRG16 = 0;
...
static STD_ReturnType EUSART_TRANSMATION_CONFIG(const usart_config_t * usart_obj)
{
    ...
    else
    {
        ...
        if(usart_obj->usart_tx_cfg.usart_asyn_tx_enable == 1)
        {
            TXSTAbits.TXEN = 1;

            if(usart_obj->usart_tx_cfg.usart_asyn_tx_itrrupt_enable == 1)
            {
                (PIE1bits.TXIE = 1);
...
# 275 "MCAL_Layer/USART/hal_usart.c"
                (INTCONbits.GIE = 1);
                (INTCONbits.PEIE = 1);
            ...
            else if(usart_obj->usart_tx_cfg.usart_asyn_tx_itrrupt_enable == 0)
            {
                (PIE1bits.TXIE = 0);
            }

            if(usart_obj->usart_tx_cfg.usart_asyn_tx_9bit_enable == 1)
            {
                TXSTAbits.TX9 = 1;
            }
            else if(usart_obj->usart_tx_cfg.usart_asyn_tx_9bit_enable == 0)
            {
                TXSTAbits.TX9 = 0;
            }
        }
        else if (usart_obj->usart_tx_cfg.usart_asyn_tx_enable == 0)
        {
            TXSTAbits.TXEN = 0;
        }
    }
...
static STD_ReturnType EUSART_RECIVING_CONFIG(const usart_config_t * usart_obj)
{
    ...
    else
    {
        ...
        if(usart_obj->usart_rx_cfg.usart_asyn_rx_enable == 1)
        {
             RCSTAbits.CREN = 1;

            if(usart_obj->usart_rx_cfg.usart_asyn_rx_itrrupt_enable == 1)
            {
                (PIE1bits.RCIE= 1);
...
# 339 "MCAL_Layer/USART/hal_usart.c"
                (INTCONbits.GIE = 1);
                (INTCONbits.PEIE = 1);
            ...
            else if(usart_obj->usart_rx_cfg.usart_asyn_rx_itrrupt_enable == 0)
            {
                (PIE1bits.RCIE = 0);
            }

            if(usart_obj->usart_rx_cfg.usart_asyn_rx_9bit_enable == 1)
            {
                RCSTAbits.RC9= 1;
            }
            else if(usart_obj->usart_tx_cfg.usart_asyn_tx_9bit_enable == 0)
