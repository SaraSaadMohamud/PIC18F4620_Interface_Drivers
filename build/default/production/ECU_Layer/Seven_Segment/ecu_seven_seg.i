...
# 34 "ECU_Layer/Seven_Segment/../../MCAL_Layer/Gpio/../mcal_std_types.h"
...
# 2 "ECU_Layer/Seven_Segment/ecu_seven_seg.c" 2
# 11 "ECU_Layer/Seven_Segment/ecu_seven_seg.c"
STD_ReturnType seven_segment_intialize(const segment_t *seg)
{
    ...
    {
        Ret = gpio_pin_intializtion(&(seg ->segment_pin[0]));
        Ret = gpio_pin_intializtion(&(seg ->segment_pin[1]));
        Ret = gpio_pin_intializtion(&(seg ->segment_pin[2]));
        Ret = gpio_pin_intializtion(&(seg ->segment_pin[3]));
    }
    return(Ret);
}
# 35 "ECU_Layer/Seven_Segment/ecu_seven_seg.c"
STD_ReturnType seven_segment_wite_number(const segment_t *seg,uint8 number)
{
    STD_ReturnType Ret = (STD_ReturnType)0X01;;
