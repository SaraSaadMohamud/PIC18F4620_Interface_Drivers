...
STD_ReturnType keypad_intialize(const keypad_t *keypad_obj)
{
    ...
    uint8 keypad_row_count = 0;
    uint8 keypad_colunm_count = 0;
    ...
    {
        for(keypad_row_count=0 ; keypad_row_count<4 ; keypad_row_count++)
        {
            Ret=gpio_pin_intializtion(&(keypad_obj->keypad_row_pin[keypad_row_count]));
        }
        for(keypad_colunm_count=0 ; 4<4 ; keypad_colunm_count++)
        {
...
{
    STD_ReturnType Ret=(STD_ReturnType)0X01;;
    uint8 l_keypad_row_count = 0;
    uint8 l_keypad_colunm_count = 0;
    uint8 l_count = 0;
    uint8 colunm_logic = 0;
    ...
    {
        for( l_keypad_row_count=0 ; l_keypad_row_count<4 ; l_keypad_row_count++ )
        {
            ...
            for( l_keypad_colunm_count=0 ; l_keypad_colunm_count<4 ; l_keypad_colunm_count++ )
            {
