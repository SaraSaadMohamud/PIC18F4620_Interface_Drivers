...
# 1 "MCAL_Layer/ADC/hal_adc_cnf.h" 1
...
# 13 "MCAL_Layer/ADC/../../MCAL_Layer/std_libraries.h"
...
# 34 "MCAL_Layer/ADC/../../MCAL_Layer/mcal_std_types.h"
...
# 1 "MCAL_Layer/ADC/../../MCAL_Layer/interrupt/mcal_interrupt_cnf.h" 1
# 15 "MCAL_Layer/ADC/../../MCAL_Layer/interrupt/mcal_interrupt_cnf.h"
# 1 "MCAL_Layer/ADC/../../MCAL_Layer/interrupt/mcal_interrupt_gen_cfg.h" 1
# 15 "MCAL_Layer/ADC/../../MCAL_Layer/interrupt/mcal_interrupt_cnf.h" 2

# 1 "MCAL_Layer/ADC/../../MCAL_Layer/interrupt/../../MCAL_Layer/Gpio/hal_gpio.h" 1
# 13 "MCAL_Layer/ADC/../../MCAL_Layer/interrupt/../../MCAL_Layer/Gpio/hal_gpio.h"
# 1 "MCAL_Layer/ADC/../../MCAL_Layer/interrupt/../../MCAL_Layer/Gpio/../device_config.h" 1
# 13 "MCAL_Layer/ADC/../../MCAL_Layer/interrupt/../../MCAL_Layer/Gpio/hal_gpio.h" 2


# 1 "MCAL_Layer/ADC/../../MCAL_Layer/interrupt/../../MCAL_Layer/Gpio/hal_gpio_cfg.h" 1
# 15 "MCAL_Layer/ADC/../../MCAL_Layer/interrupt/../../MCAL_Layer/Gpio/hal_gpio.h" 2
# 33 "MCAL_Layer/ADC/../../MCAL_Layer/interrupt/../../MCAL_Layer/Gpio/hal_gpio.h"
typedef enum
{
    LOW=0,
    HIGHT
...
# 16 "MCAL_Layer/ADC/../../MCAL_Layer/interrupt/mcal_interrupt_cnf.h" 2
# 67 "MCAL_Layer/ADC/../../MCAL_Layer/interrupt/mcal_interrupt_cnf.h"
typedef enum{
...
# 8 "MCAL_Layer/ADC/hal_adc.c" 2
    ...
    static void (* ADC_INTERRUPT_HANDELER)(void) = ((void*)0);


static __attribute__((inline)) void adc_input_channel_port_configure( adc_channel_select_t channel);
static __attribute__((inline)) void select_result_format(const adc_config_t * adc_obj);
static __attribute__((inline)) void select_voltage_refrance(const adc_config_t * adc_obj);
...
STD_ReturnType ADC_Get_Conversion_Results(const adc_config_t * adc_obj,uint16 *conversion_result)
{
    ...
    {
        if(adc_obj ->result_formate == 0X01)
        {
            *conversion_result = (uint16)( (ADRESH >> 8) + (ADRESL) ) ;
        }
        else if(adc_obj ->result_formate == 0X00)
        {
...
static __attribute__((inline)) void select_voltage_refrance(const adc_config_t * adc_obj)
{
    ...
    {
        case 0X01 :
            do{ADCON1bits.VCFG0 = 1; ADCON1bits.VCFG01 =1; }while(0);
            break;
        case 0X00 :
            do{ADCON1bits.VCFG0 = 0; ADCON1bits.VCFG01 =0 ; }while(0);
            break;
        default :
         do{ADCON1bits.VCFG0 = 0; ADCON1bits.VCFG01 =0 ; }while(0);
            break;
